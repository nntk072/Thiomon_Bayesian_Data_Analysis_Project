...
powerscale_sensitivity(model_draws, fit=thiomon_data_model_pooled) 

#Summarize the draws
model_draws |> subset_draws(variable=c('lprior','lp__'), exclude=TRUE) |> summarise_draws()
```
...
#Also the values look good!
powerscale_sensitivity(model_draws, fit=thiomon_data_model_separate)
...
# Summarize the draws
model_draws_hierarchical |> subset_draws(variable=c('lprior','lp__'), exclude=TRUE) |> summarise_draws()
...
maxit = 10000)  # For classification
