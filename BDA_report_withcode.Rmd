...
The model with covariates definitely has a better EPLD compared to the base model. Going through the exercise, the 'hgb' and 'lymph_percent' seem the dominant variables and they have 58% explanatory power.
...
The pooled model is 57.2% accurate.
...
With our chosen priors, we expect to see no prior prior sensitivity. Power-scaling with cumulative Jensen-Shannon distance diagnostic indicates no prior-data conflict.
...
The Pareto k-estimates indicate there are no observations which have k \> 0.7. Model has been refit 1 time.
