...
We choose 500 samples for fitting the model and 1K samples for checking the model performance.
...
```{r}
loo_compare(loo(thiomon_data_model_pooled), loo(thiomon_data_model_separate)) |>
  as.data.frame() |>
