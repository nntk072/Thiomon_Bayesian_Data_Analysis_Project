...
train_roc_data <- rbind(
  ...
  data.frame(roc_r2d2_improvement_train, model = paste("R2D2 prior (AUC =", round(auc_separate_improvement_1_train, 4), ")"))
)
test_roc_data <- rbind(
  data.frame(roc_separate_test, model = paste("Separate Test (AUC =", round(auc_separate_test, 4), ")")),
  ...
  data.frame(roc_r2d2_improvement_test, model = paste("R2D2 prior + more variables (AUC =", round(auc_separate_improvement_1_train, 4), ")"))
)
